  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="btn btn-outline-danger" href="user_index.php">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="btn btn-outline-danger" href="Gamelist.php">All Games</a>
      </li>
      <li class="nav-item">
        <a class="btn btn-outline-danger" href="profile.php">My Profile</a>
      </li>
      <li class="nav-item">
